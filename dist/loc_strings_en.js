...
export default {
  ...
  TID_INTRO_2: '"Obsessed with controlling territory in the new world',
  ...
  TID_CONNECTION_ERROR_OLD_VERSION_STEAM: '"Steam should auto-update to the latest version soon. If you keep getting this message',
  ...
  TID_SWITCH_TO_CONNECTED_ACCOUNT: '"Would you like to switch to your connected account? ({0}',
  TID_T1_TITLE: "Launch Fighters to destroy the enemy Battleship.",
  TID_T2_TITLE: '"Defend your Battleship with Bombers',
  ...
  TID_BS_ARTEMIS_DESCR: '"As the weakest Battleship in the Hades galaxy',
  TID_BS_APOLLO: "BATTLESHIP APOLLO",
  TID_BS_APOLLO_DESCR: '"Apollo is a well rounded ship',
  ...
  TID_BS_KRONOS_DESCR: '"Infused with poorly understood Cerberus technology',
  TID_BS_ABILITY_ATTACK_BOOST: "WAR RAGE",
  TID_BS_ABILITY_ATTACK_BOOST_DESCR: '"When manually activated',
  ...
  TID_BS_ABILITY_RESURRECTION_DESCR: '"While the Resurrection bay on Battleship Hades is active',
  TID_BS_ABILITY_GFIGHTER: "GAIA FIGHTER",
  TID_BS_ABILITY_GFIGHTER_DESCR: '"When manually activated',
  TID_BS_KRONOS_WARP: "TIME DRIVE",
  TID_BS_KRONOS_WARP_DESCR: '"The structure in front of Battleship KRONOS will periodically activate',
  TID_BS_GAIA: "BATTLESHIP GAIA",
  TID_BS_GAIA_DESCR: '"This strong and relatively agile Battleship can tactically choose when to release its attached',
  ...
  TID_CREDITS_HINT: '"<style=credits_shadow>Credits</style> can be used to upgrade Modules and Turrets',
  TID_CRYSTALS_HINT: '"<style=crystals_shadow>Crystals</style> can be used to buy Credits',
  ...
  TID_PLAYER_DETAILS_INVITE_FAIL_1: '"Invite failed',
  ...
  TID_DAILY_OFFERS_DESCR: '"Check this area every day for a free item',
  ...
  TID_ARTIFACT_HINT: '"Artifacts can be gained from Research',
  TID_BATTLESHIPS_HINT: '"Additional Battleships can be purchased from here. Once purchased',
  ...
  TID_PURCHASING_NOT_INITIALIZED: '"Purchases are not yet available',
  TID_PURCHASE_IN_PROGRESS: '"An order is already in progress',
  ...
  TID_MODULE_TYPE_FIGHTER_DESCR: '"Fighter modules spawn one or more smaller ships near your Battleship. The ships fly independently',
  TID_MODULE_TYPE_AOE: "EFFECT AREA",
  TID_MODULE_TYPE_AOE_DESCR: '"Effect Area modules create a temporary region that applies an effect to the ships inside. Use them at the right time and location to help friendly ships',
  TID_MODULE_TYPE_STRUCTURE: "STRUCTURE",
  TID_MODULE_TYPE_STRUCTURE_DESCR: '"This module creates a temporary Structure at a fixed location near the Battleship. Fighters that attack the Battleship directly will first target any Structures on their way. Structures lose HP constantly over time',
  TID_MODULE_RARITY: "RARITY",
  TID_MODULE_RARITY_0: "COMMON",
  TID_MODULE_RARITY_1: "RARE",
  TID_MODULE_COMMON_RARITY_DESCR: '"Blueprints for Common modules will be found regularly and predictably',
  TID_MODULE_RARE_RARITY_DESCR: '"Rare modules offer more exotic abilities that increase your tactical options in combat. Blueprints for these modules are harder to come by',
  ...
  TID_TURRET_QUALITY_DESCR: '"Turret Quality level ranges from 1 to 5. Higher quality Turrets have their stats improve faster on each Fusion Upgrade',
  ...
  TID_SECONDARY_STATS_DESCR: '"Secondary Stats are added randomly on certain Fusion levels. The Secondary Stats will also increase on each new fusion level',
  ...
  TID_TURRET_FUSION_TOO_HIGH_QUALITY: '"This Fusion slot requires a Turret with quality level {0}',
  ...
  TID_CONFIRM_OLD_CAMPAIGN: '"You have already finished this level. You can play it again',
  ...
  TID_TURRET_WEAK_INFO: '"Replace this weak Turret with a stronger one',
  ...
  TID_TOTAL_INFLUENCE_HINT: "\"<style=influence_shadow>Player Influence</style> indicates a player's success in Combat. Influence can be earned in Victory",
  TID_EVENTS_HS_TITLE: "AVAILABLE NOW: HADES' STAR",
  TID_EVENTS_HS_INFO: '"Play the original game that launched the Hades universe. Build your own space empire',
  ...
  TID_MOD_FIREFLY_DESCR: '"A pair of small',
  ...
  TID_MOD_ARROW: "ARROW",
  TID_MOD_ARROW_DESCR: '"Spawns a single Arrow at the activation position. The Arrow fighter will move directly towards the closest enemy Battleship',
  ...
  TID_MOD_BOMBER_DESCR: "\"The Bomber's weapon does splash damage on impact",
  TID_MOD_GHOST: "GHOST",
  ...
  TID_MOD_INTERCEPTOR_DESCR: '"With 4 rapid Batteries',
  TID_MOD_TITAN: "TITAN",
  ...
  TID_MOD_COLOSSUS_DESCR: '"This high HP fighter attacks enemy Battleships directly. It can shield weaker ships behind it',
  TID_MOD_EMP: "EMP",
  ...
  TID_MOD_CARRIER_DESCR: "\"The Carrier will periodically launch Firefly fighters. The Fireflies along with the Carrier's strong",
  ...
  TID_MOD_AREA_SHIELD_DESCR: '"Absorbs all damage done against any friendly ships in the target area. The shield loses power over time',
  TID_MOD_DESTROYER: "DESTROYER",
  TID_MOD_DESTROYER_DESCR: '"Spawns a fast',
  TID_MOD_DECAY: "DECAY",
  ...
  TID_ASSAULT_DESCR: "\"Destroy the enemy team's Base structure",
  ...
  TID_POPUP_REWARD_ARTIFACT: '"Artifacts are awarded after success in combat. Once researched',
  ...
  TID_UNLINK_STEAM_PROMPT_2: '"You will not be able to transfer any resources',
  TID_UNLINK_STEAM_PROMPT_3: '"Only your Steam progress will be reset. If you have other platforms associated with this game',
  TID_UNLINK_STEAM_PROMPT_4: '"This is your final confirmation. If you continue',
  ...
  TID_ARENA_MODULE_REWARDS_DESCR: '"Artifacts awarded after combat in this Zone will include blueprints for these modules',
  ...
  TID_NEXT_ARENA_HINT: '"Earn Influence from combat to advance to the next Zone. Higher zones yield blueprints for new Modules',
  TID_INFLUENCE_PROGRESSION_TITLE: "ZONE PROGRESSION",
  TID_INFLUENCE_PROGRESSION_HELP: '"Collect Influence to unlock rewards and reach new Zones. Higher Zones will help you find new modules',
