...
export default {
    ...
    TID_T3_INTRO_1: "In 2vs2, you and a friendly Battleship work to defeat the enemy team, before the star collapses.",
    TID_T3_INTRO_2: "Use the techniques you have learned to win the match.\\n\\nRemember, you can always replay previous Tactical Missions from the Zone Progression dialog.",
    TID_DESTROY_SINGLE_BS: "Destroy the enemy Battleship.",
    TID_DESTROY_MULTI_BS: "Destroy all enemy Battleships.",
    TID_TUT_LABEL_MP_UNLOCK: "Complete Tactical Training to unlock multiplayer battles.",
    ...
    TID_TURRET_UNLOCK_INFO: "Start earning custom Turrets by opening Turret Artifacts (earned at Zone 3 and above)",
    ...
    TID_GAME_MODE_LOCKED: "Reach zone {0} to unlock this Game Mode.",
