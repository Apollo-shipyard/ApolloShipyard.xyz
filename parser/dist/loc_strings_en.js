...
export default {
    ...
    TID_CONNECTION_ERROR_OLD_VERSION_DOWNLOAD_LINK: "UPDATE",
    ...
    TID_T1_TITLE: "FIGHTER DEPLOYMENT",
    TID_T2_TITLE: "BATTLESHIP MOVEMENT",
    TID_T3_TITLE: "DUEL TRAINING",
    TID_T1_FIREFLY_PROMPT: "The enemy is attacking with a horde of FIREFLYS.\\n\\nDeploy a BOMBER to deal with them.",
    TID_T1_COLOSSUS_PROMPT: "The COLOSSUS can lead the charge against the enemy Battleship. Deploy one now.",
    TID_T1_DEPLOY_FIGHTERS: "FIREFLY pairs work great behind the cover of COLOSSUS. Deploy several of them to assist.",
    TID_T2_MOVE_1: "Move your Battleship to avoid the red collapsing zone. Fighters and Battleships caught in the collapse are immediately destroyed.",
    TID_T2_DEFEND_AGAINST_COLOSSUS: "Defend against the enemy Colossus by deploying a large Firefly army.",
    TID_T2_MOVE_2: "Move closer to the enemy Battleship.",
    TID_T2_DEPLOY_COLOSSUS: "Deploy COLOSSUS to start your attack.",
    TID_T2_DEPLOY_ARROWS: "ARROW can attack the enemy Battleship from a safe distance. Deploy some behind the COLOSSUS.",
    TID_T3_INTRO_1: "In DUEL, you face a single enemy Battleship that you must defeat. Fighters that spawn randomly on the map will attack the closest fighters from either player.",
    TID_T3_INTRO_2: "Use the techniques you have learned to win the match.\\n\\nRemember, you can always replay previous Tactical Missions from the Influence Map screen.",
    TID_T3_MOVE_HINT: "Try staying at the edges of the map as long as possible. Going towards the center too early can leave you surrounded by enemy fighters.",
    ...
    TID_BS_ZEUS: "BATTLESHIP ZEUS",
    TID_BS_ZEUS_DESCR: "Armed with a Nuclear Warhead that can be manually launched anywhere on the map, Zeus offers a flexible turret layout, strong hull and reasonable speed.",
    TID_BS_MERCURY: "BATTLESHIP MERCURY",
    TID_BS_MERCURY_DESCR: "With its superior movement ability, Mercury can be used to avoid direct confrontation, quickly ambush enemies, or reach strategic points on the map before any other Battleships.",
    TID_BS_ATHENA: "BATTLESHIP ATHENA",
    TID_BS_ATHENA_DESCR: "Athena comes equipped with a regenerating shield, allowing the ship to take calculated risks and be more aggressive in combat.",
    ...
    TID_BS_ABILITY_TELEPORT: "TELEPORT",
    TID_BS_ABILITY_TELEPORT_DESCR: "When ordered to move, the Battleship rotates to face its destination, then instantly teleports to its location after a fixed Teleport Delay. The Teleport Delay does not depend on the distance travelled.\\n\\nDuring the Teleport Delay, the Battleship does not regenerate Hydrogen.",
    TID_BS_ABILITY_REGEN_SHIELD: "REGENERATING SHIELD",
    TID_BS_ABILITY_REGEN_SHIELD_DESCR: "A shield that absorbs all damage taken by the Battleship. After the shield is depleted, the ship starts taking direct damage.\\n\\nIf the shield and ship hull have not been taking damage during the Regeneration Delay, the shield HP will start refilling automatically.",
    TID_BS_ABILITY_TELEPORT_DELAY: "TELEPORT DELAY",
    TID_SHIELD_MAX_HP: "SHIELD MAX HP",
    TID_SHIELD_REGEN_DELAY: "REGENERATION DELAY",
    TID_SHIELD_REGEN_PER_SECOND: "HP REGENERATION/sec",
    ...
    TID_WAIT_TIME: "Maximum wait time: ",
    TID_WAIT_TIME_UNKNOWN: "UNKNOWN",
    ...
    TID_CORP_DETAILS_VIEW: "View Corporation",
    TID_INBOX_BTN: "INBOX",
    TID_ACCEPT_ALLIANCE_INVITE: "JOIN CORPORATION",
    TID_INBOX_EMPTY: "You have no messages in your Inbox.",
    TID_INBOX_TIMESTAMP: "{0} ago",
    TID_INBOX_COLLECT_REWARD: "COLLECT",
    TID_RANKED_SEASON_ENDED_RP_REWARD: "A Ranked Season has ended. Your Battleships were reset to base Influence. For the {1} total Influence deducted, you are awarded {0} RP.",
    ...
    TID_ARTIFACT_COMBAT_SMALL: "MODULE ARTIFACT",
    TID_ARTIFACT_COMBAT_LARGE: "MODULE ARTIFACT",
    TID_ARTIFACT_TURRET_SMALL: "TURRET ARTIFACT",
    TID_ARTIFACT_TURRET_LARGE: "TURRET ARTIFACT",
    TID_ARTIFACT_SHIPXP: "SHIP XP ARTIFACT",
    ...
    TID_RESEARCH_PROGRESS_HINT: "The Research Bar indicates your progress toward the next research reward. Earn Research Points from Combat missions to fill the bar.",
    ...
    TID_NOT_DISCOVERED_MODULES: "NOT YET DISCOVERED",
    TID_NOT_DISCOVERED_MODULES_HINT: "Open more Artifacts from Combat for a chance to unlock these modules.",
    ...
    TID_MODULES_SORT_BY_NAME: "By Name",
    TID_MODULES_SORT_BY_HYDRO_ASC: "By Hydrogen Use (smaller first)",
    TID_MODULES_SORT_BY_HYDRO_DESC: "By Hydrogen Use (larger first)",
    ...
    TID_MODULE_COMMON_RARITY_DESCR: "Common modules offer well rounded tactical options and are generally faster to upgrade.",
    ...
    TID_MODULE_STAT_ROCKETS_LAUNCHED: "ROCKETS LAUNCHED",
    TID_MODULE_STAT_FIGHTERS_LAUNCHED_NUMBER_PER_PERIOD: "x{0} / {1}",
    TID_MODULE_STAT_ROCKET_HP: "ROCKET HP",
    TID_MODULE_STAT_ROCKET_DAMAGE: "ROCKET DAMAGE",
    ...
    TID_MODULE_STAT_WEAPON_RANGE_MIN: "MINIMUM RANGE",
    TID_MODULE_STAT_WEAPON_RANGE_MAX: "MAXIMUM RANGE",
    TID_MODULE_STAT_AOE_RANGE: "EFFECT RANGE",
    TID_MODULE_STAT_AOE_DURATION: "EFFECT DURATION",
    TID_MODULE_STAT_AOE_FIGHTERS_SPAWNED: "TOTAL FIGHTERS SPAWNED",
    ...
    TID_MODULE_STAT_FIRE_SLOW: "FIRE RATE REDUCTION",
    ...
    TID_MODULE_STAT_DEATH_FX_HEAL_RADIUS: "HEAL RADIUS",
    TID_MODULE_STAT_DEATH_FX_HEAL: "HEAL AMOUNT",
    TID_MODULE_STAT_HEAL_DURATION: "HEAL DURATION",
    TID_MODULE_STAT_RAGE_DURATION: "WAR RAGE DURATION",
    TID_MODULE_STAT_RAGE_RADIUS: "WAR RAGE RADIUS",
    ...
    TID_COMBAT_RANKED: "RANKED",
    TID_COMBAT_UNRANKED: "NOT RANKED",
    TID_GAME_MODE_STARTS_IN_TIME: "{0} starts in {1}",
    TID_TRAINING: "TRAINING",
    TID_SELECT_MODULES_DLG_TITLE: "SELECT MODULE",
    TID_MODULES_EQUIPPED: "EQUIPPED MODULES",
    TID_MODULES_AVERAGE_COST: "AVERAGE COST",
    ...
    TID_TURRET_UNLOCK_INFO: "Keep earning Influence to unlock custom Turrets that can be fitted on your Battleships.",
    ...
    TID_TURRET_WEAK_INFO: "Replace this basic Turret with a custom one, to increase your ship's firepower.",
    TID_TURRET_WEAK_INFO_OTHER_PLAYER: "A basic Turret that does a small amount of damage.",
    ...
    TID_BTN_BATTLESHIPS: "CHANGE BATTLESHIP",
    TID_LBL_LOCKED_BATTLESHIPS: "LOCKED BATTLESHIPS",
    TID_SELECT_BATTLESHIP: "SELECT",
    TID_BATTLESHIP_COMMON_LOCKED: "Gain more Influence to unlock this Battleship.",
    TID_BATTLESHIP_RARE_LOCKED: "Open more Ship XP artifacts for a chance to unlock this Battleship.",
    TID_SHIP_RANK: "RANK",
    ...
    TID_MODE_SELECTION: "MODE SELECTION",
    TID_SELECT_GAME_MODE: "Select a game mode for Combat:",
    TID_RANKED_GAMEMODE: "RANKED",
    TID_NOT_RANKED_GAMEMODE: "NOT RANKED",
    ...
    TID_NUM_MEMBERS_ONLINE: "{0}/{1} members online",
    TID_CORP_RANK_NONE: "NOT RANKED",
    TID_CORP_RANK: "#{0} GLOBALLY",
    TID_CORP_RANK_TOOLTIP: "Gain Ranked points from daily Combat to help your Corporation climb the Leaderboards. Only your first 3 battles of each day contribute.\\n\\nCorporation leaderboards reset every week.",
    TID_CORP_RANK_LDB_BUTTON: "VIEW LEADERBOARD",
    TID_REQUEST_TEAMMATE_CONFIRM: "Start looking for a Combat teammate?\\n\\nIf you proceed, a chat entry will notify other Corporation members you are looking to team up for Combat.",
    ...
    TID_TEAMMATE_NOT_SUPPORTED: "The currently selected Combat mode does not support teams.",
    ...
    TID_LEADERBOARD_PLAYER: "PLAYERS",
    TID_LEADERBOARD_SHIPS: "BATTLESHIPS",
    TID_LEADERBOARD_CORPORATIONS: "CORPORATIONS",
    TID_LEADERBOARD_CORP_SEASON_ENDS_IN: "Weekly Period Ends in:",
    TID_LEADERBOARD_RANKED_SEASON_ENDS_IN: "Ranked Period Ends in:",
    TID_LEADERBOARD_CORP_SEASON_INFO: "Corporation leaderboards are under development. During Early Access, they can be used to evaluate Corporation activity.",
    TID_LEADERBOARD_RANKED_SEASON_INFO: "At the end of each Ranked Season, all Battleships for all players will be capped to {0} Influence. A percentage of the total Influence removed will be added back as Research Points at the season's end.",
    ...
    TID_MOD_DARK_COLOSSUS: "DARK COLOSSUS",
    TID_MOD_DARK_COLOSSUS_DESCR: "A stealthed, more durable version of the Colossus. When destroyed it will spawn a War Rage effect for a limited time. Directly attacks Battleships and enemy structures.",
    TID_MOD_LIGHT_COLOSSUS: "LIGHT COLOSSUS",
    TID_MOD_LIGHT_COLOSSUS_DESCR: "This stronger version of the Colossus will heal nearby units for a short period of time after being destroyed. Directly attacks Battleships and enemy structures.",
    TID_MOD_EMP: "EMP",
    TID_MOD_EMP_DESCR: "Stuns all enemy Fighters and Battleship Turrets in the effect range. Stunned ships cannot move, fire or increase their spawn timer. Stunned ships will also have their target reset.",
    ...
    TID_MOD_NUCLEARBOMB_DESCR: "A very powerful bomb that does massive area damage to all enemy Fighters and Battleships inside the small impact area. Can be targeted anywhere on the map. The time to detonation is proportional to the distance the bomb needs to travel to reach its destination.",
    TID_MOD_PORTAL: "PORTAL",
    TID_MOD_PORTAL_DESCR: "Constantly spawns Stealth Firefly fighters while the effect is active.",
    ...
    TID_MOD_STEALTH_TANK: "STEALTH TANK",
    TID_MOD_STEALTH_TANK_DESCR: "This slow moving, high HP fighter can be used to defend against constant streams of weak fighters, and to distract stronger enemy fighters, providing cover to your weaker units passing through.",
    TID_MOD_PHOENIX: "PHOENIX",
    TID_MOD_PHOENIX_DESCR: "With its extremely strong hull, Phoenix can distract multiple turrets and enemy fighters near enemy Battleships. After its destruction, it will leave behind a large number of Stealth Fireflies.",
    TID_MOD_ROCKET_LAUNCHER: "ROCKET LAUNCHER",
    TID_MOD_ROCKET_LAUNCHER_DESCR: "Launches pairs of powerful Rockets against distant enemy Battleships and Structures located between the minimum and maximum firing range. The Rockets will gradually become faster with time. If a Rocket's target is destroyed, the Rocket is deactivated without doing any damage.",
    TID_MOD_WISP: "WISP",
    TID_MOD_WISP_DESCR: "A pair of weak fighters that can be deployed anywhere on the map.",
    TID_MOD_WISP_SQUAD: "WISP SQUAD",
    TID_MOD_WISP_SQUAD_DESCR: "A group of Wisp fighters that can be deployed anywhere on the map.",
    TID_MOD_WISP_STEALTH: "STEALTH WISP",
    TID_MOD_WISP_STEALTH_DESCR: "The stealth version of Wisp. Can be deployed anywhere on the map. Can only be targeted by Battleships or Fighters that have stealth weapons.",
    TID_2VS2: "2 VS 2",
    ...
    TID_ASSAULT_DESCR: "Destroy the enemy Base structure, while protecting your own.",
    TID_DUEL: "DUEL",
    TID_DUEL_DESCR: "Destroy the enemy Battleship.",
    TID_CTR: "RELIC CAPTURE",
    TID_CTR_DESCR: "Collect Relics and return them to your side of the map to capture them.",
    TID_ESCORT: "ESCORT",
    TID_ESCORT_DESCR: "Depending on your side, you must destroy or protect the neutral Battleship until it reaches its destination.",
    TID_ESCORT_DESCR_P1: "Protect the neutral Battleship until it reaches its destination.",
    TID_ESCORT_DESCR_P2: "Destroy the neutral Battleship before it reaches its destination.",
    ...
    TID_YOUR_SCORE: "YOUR RELICS",
    TID_ENEMY_SCORE: "ENEMY RELICS",
    ...
    TID_ACCOUNT_LOGGEDIN_GAMECENTER: "Your progress is being saved to your Game Center account. To access your game from another iPhone or iPad, sign in with the same Game Center account from the new device's Settings app.\\n\\nTo access your game from a different type of device, press the Link button below.",
    TID_LINK_BACK_BUTTON: "< BACK",
    ...
    TID_INFLUENCE_PROGRESSION_TITLE: "INFLUENCE MAP",
    TID_INFLUENCE_PROGRESSION_HELP: "Collect additional Influence to unlock the next Reward. Once you reach {0} Influence, you will gain access to the weekly Ranked competition.",
    ...
    NOTIF_RP_BAR_FULL: "Your Combat Research Points bar is full. Head back to battle to claim additional rewards, and allow the bar to refill.",
    ...
    TID_OBJ_WIN_COMBAT_WITH_SHIP: "Win {0} matches with {1}.",
    TID_OBJ_WIN_COMBAT_WITH_MODULE: "Win {0} matches using a battleship equipped with {1}.",
    TID_OBJ_PLAY_COMBAT_WITH_MODULE: "Play {0} matches using a battleship equipped with {1}.",
    TID_OBJ_WIN_ANY: "Win {0} matches.",
    TID_BUTTON_CLAIM: "CLAIM",
    TID_OVERLAY_MODULE_UNLOCKED: "NEW MODULE UNLOCKED",
    TID_OVERLAY_SHIP_UNLOCKED: "BATTLESHIP UNLOCKED",
    TID_OVERLAY_SHIPXP_GAINED: "SHIP XP",
};
